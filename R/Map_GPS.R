...
# file paths
GPS_logs_path <- "/home/manuel/Downloads/tracker_data.xls"
...
GPS_html$Latitude <- as.numeric(sub("°", "", GPS_html$Latitude))
GPS_html$Longitude <- as.numeric(sub("°", "", GPS_html$Longitude))
